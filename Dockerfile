...
RUN git clone --depth 1 --branch $X264_BRANCH https://github.com/ffmpegwasm/x264.git /src
...
ENV X265_BRANCH=3.4
RUN git clone --depth 1 --branch $X265_BRANCH https://github.com/ffmpegwasm/x265.git /src
...
RUN git clone --depth 1 --branch $LIBVPX_BRANCH https://github.com/ffmpegwasm/libvpx.git /src
...
RUN git clone --depth 1 --branch $LAME_BRANCH https://github.com/ffmpegwasm/lame.git /src
...
RUN git config --global http.postBuffer 524288000 && \
    ...
    git clone --depth 1 --branch $LIBWEBP_BRANCH https://github.com/ffmpegwasm/libwebp.git /src
...
RUN git config --global http.postBuffer 524288000 && \
    git config --global http.maxRequests 5 && \
    git clone --depth 1 --branch $FREETYPE2_BRANCH https://github.com/ffmpegwasm/freetype2.git /src
...
RUN git config --global http.postBuffer 524288000 && \
    git config --global http.maxRequests 5 && \
    git clone --depth 1 --branch $FRIBIDI_BRANCH https://github.com/fribidi/fribidi.git /src
...
RUN git config --global http.postBuffer 524288000 && \
    git config --global http.maxRequests 5 && \
    git clone --depth 1 --branch $HARFBUZZ_BRANCH https://github.com/harfbuzz/harfbuzz.git /src
...
RUN git clone --depth 1 --branch $LIBASS_BRANCH https://github.com/libass/libass.git /src
...
RUN git clone --depth 1 --branch $FFMPEG_VERSION https://github.com/FFmpeg/FFmpeg.git /src
